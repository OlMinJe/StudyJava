...
public class Exam10 {
	...
	*/
	private static String format(String str, int length, int alignment) {
		...
		int diff = result.length - source.length;
		switch (alignment) {
			case 0: System.arraycopy(source, 0, result, 0, source.length); break;
			case 1: System.arraycopy(source, 0, result, diff/2, source.length); break;
			case 2: System.arraycopy(source, 0, result, diff, source.length); break;
		}
